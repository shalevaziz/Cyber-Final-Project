...
class Client(basics.Encrypted_TCP_Client):
    ...
    def share_screen(self):
        ...
        Thread(target=self.__share_screen, args=(local_ip, local_port, dest_ip, dest_port)).start()
        
    
    def __share_screen(self, local_ip, local_port, dest_ip, dest_port):
...
def main():
    client = Client('10.30.56.224', 25565)
